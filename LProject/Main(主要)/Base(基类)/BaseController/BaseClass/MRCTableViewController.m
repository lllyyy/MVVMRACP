...
- (void)setupTableView {
    self.tableView = [[UITableView alloc]initWithFrame: CGRectMake(0, self.customNavBar.bottom , kScreenWidth, kScreenHeight - NAVIGATION_BAR_HEIGHT) style:UITableViewStyleGrouped];
