...
- (void)viewDidLoad {
    ...
    self.collectionViews = [[UICollectionView alloc] initWithFrame: CGRectMake(0, NAVIGATION_BAR_HEIGHT, kScreenWidth, kScreenHeight - NAVIGATION_BAR_HEIGHT) collectionViewLayout:layout];
